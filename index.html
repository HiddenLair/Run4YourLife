...
<html lang="en">
  ...
  <head>
    ...
    <title>Hidden Lair Studio</title>
  ...
  <body id="page-top">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark fixed-top" id="mainNav">
      <div class="container">
        <a href="#">
              <img class="img-fluid d-block mx-auto" src="img/logos/hl_logo.png" width="100px" alt="">
            </a>
    ...
    <header class="masthead">
      <div class="container">
        ...
        <div class="intro-text">
          ...
          <div class="intro-heading text-uppercase">Get our build for free!</div>
          <a class="btn btn-primary btn-xl text-uppercase js-scroll-trigger" href="#">Download</a>
        </div>
      </div>
    </header>
      ...
      <div >
        <div >
          <div class="col-lg-12 text-center">
            ...
            <h3 class="section-subheading text-muted">Check out our development blog</h3>
			<a class="btn btn-primary btn-xl text-uppercase js-scroll-trigger" href="#">Blog</a>
          </div><br><br>
        </div>
		<div width="auto"  style="background-color:black">
		

<iframe allowFullScreen="true" style="margin-left: auto; margin-right: auto; display: block; color:black; border:0 " width="1300" height="700"
src="https://www.youtube.com/embed/yarB8CstXHM">
</iframe>
            ...
            <ul class="timeline">
              <li>
                <div class="timeline-image">
                  <img class="rounded-circle img-fluid" src="img/logos/hl_logo.png" width="125" alt="">
                </div>
              ...
              <li class="timeline-inverted">
                <div class="timeline-image">
                  <img class="rounded-circle img-fluid" src="img/R4YL_logo.png" alt="">
                </div>
                <div class="timeline-panel">
                  <div class="timeline-heading">
                    <h4>December 2018</h4>
    ...
    <section style="background-color: #dfcbe0;" id="team">
      <div class="container">
		...
		<div class="row">
          <div class="col-sm-4">
            <div class="team-member">
              ...
              <ul class="list-inline social-buttons">
                <li class="list-inline-item">
                  <a href="https://www.artstation.com/pausp1">
                    <i class="fa"><font face="verdana"><b>A</b></font></i>
                  </a>
                </li>
                <li class="list-inline-item">
          ...
          <div class="col-sm-4">
            <div class="team-member">
              ...
              <ul class="list-inline social-buttons">
                <li class="list-inline-item">
                  <a href="https://www.artstation.com/aenerida">
                    <i class="fa"><font face="verdana"><b>A</b></font></i>
                  </a>
                </li>
                <li class="list-inline-item">
          ...
          <div class="col-sm-4">
            <div class="team-member">
              ...
              <ul class="list-inline social-buttons">
                <li class="list-inline-item">
                  <a href="https://www.artstation.com/martafm1">
                    <i class="fa"><font face="verdana"><b>A</b></font></i>
                  </a>
                </li>
                <li class="list-inline-item">
		...
		<div class="row">
          ...
          <div class="col-sm-4">
            <div class="team-member">
              <img class="mx-auto rounded-circle" src="img/team/gerard.png" alt="">
              <h4>Gerard Pros</h4>
        ...
        <div class="row">
          ...
          <div class="col-md-4">
            <ul class="list-inline quicklinks">
              <li class="list-inline-item">
                <a href="mailto:hiddenlairstudio.contact@gmail.com">hiddenlairstudio.contact@gmail.com</a>
              </li>
